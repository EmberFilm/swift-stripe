//
//  Generated.AccountsClient.swift
//  Stripe
//
...
public protocol AccountsAPI: Sendable {
    ...
    func reject(id: Stripe.Connect.Account.ID, _ request: Stripe.Connect.Account.Reject.Request, idempotencyKey: String?) async throws -> Stripe.Connect.Account.Reject.Response
    func retrieve(id: Stripe.Connect.Account.ID, _ request: Stripe.Connect.Account.Retrieve.Request) async throws -> Stripe.Connect.Account.Retrieve.Response
    ...
    func unreject(id: Stripe.Connect.Account.ID, _ request: Stripe.Connect.Account.Unreject.Request, idempotencyKey: String?) async throws -> Stripe.Connect.Account.Unreject.Response
    func update(id: Stripe.Connect.Account.ID, _ request: Stripe.Connect.Account.Update.Request, idempotencyKey: String?) async throws -> Stripe.Connect.Account.Update.Response
}
...
public struct AccountsClient: AccountsAPI {
    ...
    public func create(_ request: Stripe.Connect.Account.Create.Request, idempotencyKey: String?) async throws -> Stripe.Connect.Account.Create.Response {
    ...
    public func reject(id: Stripe.Connect.Account.ID, _ request: Stripe.Connect.Account.Reject.Request, idempotencyKey: String?) async throws -> Stripe.Connect.Account.Reject.Response {
        try await api.send(.POST, "v1/accounts/\(id)/reject", body: request, idempotencyKey: idempotencyKey)
    }

    public func retrieve(id: Stripe.Connect.Account.ID, _ request: Stripe.Connect.Account.Retrieve.Request) async throws -> Stripe.Connect.Account.Retrieve.Response {
        try await api.list("v1/accounts/\(id)", parameters: request)
    }

    public func retrieveCurrent(_ request: Stripe.Connect.Account.RetrieveCurrent.Request) async throws -> Stripe.Connect.Account.RetrieveCurrent.Response {
        try await api.list("v1/account", parameters: request)
    }

    public func unreject(id: Stripe.Connect.Account.ID, _ request: Stripe.Connect.Account.Unreject.Request, idempotencyKey: String?) async throws -> Stripe.Connect.Account.Unreject.Response {
        try await api.send(.POST, "v1/accounts/\(id)/unreject", body: request, idempotencyKey: idempotencyKey)
    }

    public func update(id: Stripe.Connect.Account.ID, _ request: Stripe.Connect.Account.Update.Request, idempotencyKey: String?) async throws -> Stripe.Connect.Account.Update.Response {
...
extension AccountsAPI {
    ...
    public func reject(id: Stripe.Connect.Account.ID, _ request: Stripe.Connect.Account.Reject.Request) async throws -> Stripe.Connect.Account.Reject.Response {
    ...
    public func unreject(id: Stripe.Connect.Account.ID, _ request: Stripe.Connect.Account.Unreject.Request) async throws -> Stripe.Connect.Account.Unreject.Response {
    ...
    public func update(id: Stripe.Connect.Account.ID, _ request: Stripe.Connect.Account.Update.Request) async throws -> Stripe.Connect.Account.Update.Response {
