//
//  Generated.ApplePayDomainsClient.swift
//  Stripe
//
...
public protocol ApplePayDomainsAPI: Sendable {
    ...
    func retrieve(id: Stripe.ApplePayDomain.ID, _ request: Stripe.ApplePayDomain.Retrieve.Request) async throws -> Stripe.ApplePayDomain.Retrieve.Response
}
...
public struct ApplePayDomainsClient: ApplePayDomainsAPI {
    ...
    public func retrieve(id: Stripe.ApplePayDomain.ID, _ request: Stripe.ApplePayDomain.Retrieve.Request) async throws -> Stripe.ApplePayDomain.Retrieve.Response {
