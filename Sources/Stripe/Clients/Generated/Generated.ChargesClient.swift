...
public protocol ChargesAPI: Sendable {
    func capture(id: Stripe.Charges.Charge.ID, _ request: Stripe.Charges.Charge.Capture.Request, idempotencyKey: String?) async throws -> Stripe.Charges.Charge.Capture.Response
    ...
    func retrieve(id: Stripe.Charges.Charge.ID, _ request: Stripe.Charges.Charge.Retrieve.Request) async throws -> Stripe.Charges.Charge.Retrieve.Response
    func search(_ request: Stripe.Charges.Charge.Search.Request) async throws -> Stripe.Charges.Charge.Search.Response
    func update(id: Stripe.Charges.Charge.ID, _ request: Stripe.Charges.Charge.Update.Request, idempotencyKey: String?) async throws -> Stripe.Charges.Charge.Update.Response
}
...
public struct ChargesClient: ChargesAPI {
    ...
    public func capture(id: Stripe.Charges.Charge.ID, _ request: Stripe.Charges.Charge.Capture.Request, idempotencyKey: String?) async throws -> Stripe.Charges.Charge.Capture.Response {
    ...
    public func retrieve(id: Stripe.Charges.Charge.ID, _ request: Stripe.Charges.Charge.Retrieve.Request) async throws -> Stripe.Charges.Charge.Retrieve.Response {
    ...
    public func update(id: Stripe.Charges.Charge.ID, _ request: Stripe.Charges.Charge.Update.Request, idempotencyKey: String?) async throws -> Stripe.Charges.Charge.Update.Response {
...
extension ChargesAPI {
    public func capture(id: Stripe.Charges.Charge.ID, _ request: Stripe.Charges.Charge.Capture.Request) async throws -> Stripe.Charges.Charge.Capture.Response {
    ...
    public func update(id: Stripe.Charges.Charge.ID, _ request: Stripe.Charges.Charge.Update.Request) async throws -> Stripe.Charges.Charge.Update.Response {
