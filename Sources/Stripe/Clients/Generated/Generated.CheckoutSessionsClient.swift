//
//  Generated.CheckoutSessionsClient.swift
//  Stripe
//
...
public protocol CheckoutSessionsAPI: Sendable {
    ...
    func expire(id: Stripe.Checkout.Session.ID, _ request: Stripe.Checkout.Session.Expire.Request, idempotencyKey: String?) async throws -> Stripe.Checkout.Session.Expire.Response
    func list(_ request: Stripe.Checkout.Session.List.Request) async throws -> Stripe.Checkout.Session.List.Response
    func listLineItems(id: Stripe.Checkout.Session.ID, _ request: Stripe.Checkout.Session.ListLineItems.Request) async throws -> Stripe.Checkout.Session.ListLineItems.Response
    func retrieve(id: Stripe.Checkout.Session.ID, _ request: Stripe.Checkout.Session.Retrieve.Request) async throws -> Stripe.Checkout.Session.Retrieve.Response
    func update(id: Stripe.Checkout.Session.ID, _ request: Stripe.Checkout.Session.Update.Request, idempotencyKey: String?) async throws -> Stripe.Checkout.Session.Update.Response
}
...
public struct CheckoutSessionsClient: CheckoutSessionsAPI {
    ...
    public func create(_ request: Stripe.Checkout.Session.Create.Request, idempotencyKey: String?) async throws -> Stripe.Checkout.Session.Create.Response {
        try await api.send(.POST, "v1/checkout/sessions", body: request, idempotencyKey: idempotencyKey)
    }

    public func expire(id: Stripe.Checkout.Session.ID, _ request: Stripe.Checkout.Session.Expire.Request, idempotencyKey: String?) async throws -> Stripe.Checkout.Session.Expire.Response {
    ...
    public func listLineItems(id: Stripe.Checkout.Session.ID, _ request: Stripe.Checkout.Session.ListLineItems.Request) async throws -> Stripe.Checkout.Session.ListLineItems.Response {
        try await api.list("v1/checkout/sessions/\(id)/line_items", parameters: request)
    }

    public func retrieve(id: Stripe.Checkout.Session.ID, _ request: Stripe.Checkout.Session.Retrieve.Request) async throws -> Stripe.Checkout.Session.Retrieve.Response {
        try await api.list("v1/checkout/sessions/\(id)", parameters: request)
    }

    public func update(id: Stripe.Checkout.Session.ID, _ request: Stripe.Checkout.Session.Update.Request, idempotencyKey: String?) async throws -> Stripe.Checkout.Session.Update.Response {
...
extension CheckoutSessionsAPI {
    ...
    public func expire(id: Stripe.Checkout.Session.ID, _ request: Stripe.Checkout.Session.Expire.Request) async throws -> Stripe.Checkout.Session.Expire.Response {
    ...
    public func update(id: Stripe.Checkout.Session.ID, _ request: Stripe.Checkout.Session.Update.Request) async throws -> Stripe.Checkout.Session.Update.Response {
