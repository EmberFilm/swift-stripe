//
//  Generated.ClimateOrdersClient.swift
//  Stripe
//
...
public protocol ClimateOrdersAPI: Sendable {
    func cancel(id: Stripe.Climate.Order.ID, _ request: Stripe.Climate.Order.Cancel.Request, idempotencyKey: String?) async throws -> Stripe.Climate.Order.Cancel.Response
    ...
    func retrieve(id: Stripe.Climate.Order.ID, _ request: Stripe.Climate.Order.Retrieve.Request) async throws -> Stripe.Climate.Order.Retrieve.Response
    func update(id: Stripe.Climate.Order.ID, _ request: Stripe.Climate.Order.Update.Request, idempotencyKey: String?) async throws -> Stripe.Climate.Order.Update.Response
}
...
public struct ClimateOrdersClient: ClimateOrdersAPI {
    ...
    public func cancel(id: Stripe.Climate.Order.ID, _ request: Stripe.Climate.Order.Cancel.Request, idempotencyKey: String?) async throws -> Stripe.Climate.Order.Cancel.Response {
    ...
    public func retrieve(id: Stripe.Climate.Order.ID, _ request: Stripe.Climate.Order.Retrieve.Request) async throws -> Stripe.Climate.Order.Retrieve.Response {
        try await api.list("v1/climate/orders/\(id)", parameters: request)
    }

    public func update(id: Stripe.Climate.Order.ID, _ request: Stripe.Climate.Order.Update.Request, idempotencyKey: String?) async throws -> Stripe.Climate.Order.Update.Response {
...
extension ClimateOrdersAPI {
    public func cancel(id: Stripe.Climate.Order.ID, _ request: Stripe.Climate.Order.Cancel.Request) async throws -> Stripe.Climate.Order.Cancel.Response {
    ...
    public func update(id: Stripe.Climate.Order.ID, _ request: Stripe.Climate.Order.Update.Request) async throws -> Stripe.Climate.Order.Update.Response {
