//
//  Generated.EphemeralKeysClient.swift
//  Stripe
//
...
public protocol EphemeralKeysAPI: Sendable {
    ...
    func delete(id: Stripe.EphemeralKey.ID, _ request: Stripe.EphemeralKey.Delete.Request, idempotencyKey: String?) async throws -> Stripe.EphemeralKey.Delete.Response
}
...
public struct EphemeralKeysClient: EphemeralKeysAPI {
    ...
    public func delete(id: Stripe.EphemeralKey.ID, _ request: Stripe.EphemeralKey.Delete.Request, idempotencyKey: String?) async throws -> Stripe.EphemeralKey.Delete.Response {
