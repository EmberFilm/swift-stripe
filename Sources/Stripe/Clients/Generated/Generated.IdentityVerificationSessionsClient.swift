//
//  Generated.IdentityVerificationSessionsClient.swift
//  Stripe
//
...
public protocol IdentityVerificationSessionsAPI: Sendable {
    func cancel(id: VerificationSession.ID, _ request: VerificationSession.Cancel.Request, idempotencyKey: String?) async throws -> VerificationSession.Cancel.Response
    ...
    func redact(id: VerificationSession.ID, _ request: VerificationSession.Redact.Request, idempotencyKey: String?) async throws -> VerificationSession.Redact.Response
    ...
    func update(id: VerificationSession.ID, _ request: VerificationSession.Update.Request, idempotencyKey: String?) async throws -> VerificationSession.Update.Response
}
...
public struct IdentityVerificationSessionsClient: IdentityVerificationSessionsAPI {
    ...
    public func cancel(id: VerificationSession.ID, _ request: VerificationSession.Cancel.Request, idempotencyKey: String?) async throws -> VerificationSession.Cancel.Response {
    ...
    public func redact(id: VerificationSession.ID, _ request: VerificationSession.Redact.Request, idempotencyKey: String?) async throws -> VerificationSession.Redact.Response {
        try await api.send(.POST, "v1/identity/verification_sessions/\(id)/redact", body: request, idempotencyKey: idempotencyKey)
    }

    public func retrieve(id: VerificationSession.ID, _ request: VerificationSession.Retrieve.Request) async throws -> VerificationSession.Retrieve.Response {
        try await api.list("v1/identity/verification_sessions/\(id)", parameters: request)
    }

    public func update(id: VerificationSession.ID, _ request: VerificationSession.Update.Request, idempotencyKey: String?) async throws -> VerificationSession.Update.Response {
