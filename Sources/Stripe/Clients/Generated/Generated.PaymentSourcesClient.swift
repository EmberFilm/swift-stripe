...
public protocol PaymentSourcesAPI: Sendable {
    func create(customer: String, _ request: Stripe.PaymentSource.Create.Request, idempotencyKey: String?) async throws -> Stripe.PaymentSource.Create.Response
    func list(customer: String, _ request: Stripe.PaymentSource.List.Request) async throws -> Stripe.PaymentSource.List.Response
    func retrieve(customer: String, id: String, _ request: Stripe.PaymentSource.Retrieve.Request) async throws -> Stripe.PaymentSource.Retrieve.Response
}
...
public struct PaymentSourcesClient: PaymentSourcesAPI {
    ...
    public func create(customer: String, _ request: Stripe.PaymentSource.Create.Request, idempotencyKey: String?) async throws -> Stripe.PaymentSource.Create.Response {
    ...
    public func retrieve(customer: String, id: String, _ request: Stripe.PaymentSource.Retrieve.Request) async throws -> Stripe.PaymentSource.Retrieve.Response {
