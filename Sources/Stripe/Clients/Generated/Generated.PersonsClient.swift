...
public protocol PersonsAPI: Sendable {
    func create(account: String, _ request: Stripe.Connect.Person.Create.Request, idempotencyKey: String?) async throws -> Stripe.Connect.Person.Create.Response
    ...
    func retrieve(account: String, person: Stripe.Connect.Person.ID, _ request: Stripe.Connect.Person.Retrieve.Request) async throws -> Stripe.Connect.Person.Retrieve.Response
    func update(account: String, person: Stripe.Connect.Person.ID, _ request: Stripe.Connect.Person.Update.Request, idempotencyKey: String?) async throws -> Stripe.Connect.Person.Update.Response
}
...
public struct PersonsClient: PersonsAPI {
    ...
    public func create(account: String, _ request: Stripe.Connect.Person.Create.Request, idempotencyKey: String?) async throws -> Stripe.Connect.Person.Create.Response {
        try await api.send(.POST, "v1/accounts/\(account)/persons", body: request, idempotencyKey: idempotencyKey)
    }

    public func delete(account: String, person: Stripe.Connect.Person.ID, idempotencyKey: String?) async throws -> Stripe.Connect.Person.Delete.Response {
    ...
    public func retrieve(account: String, person: Stripe.Connect.Person.ID, _ request: Stripe.Connect.Person.Retrieve.Request) async throws -> Stripe.Connect.Person.Retrieve.Response {
        try await api.list("v1/accounts/\(account)/persons/\(person)", parameters: request)
    }

    public func update(account: String, person: Stripe.Connect.Person.ID, _ request: Stripe.Connect.Person.Update.Request, idempotencyKey: String?) async throws -> Stripe.Connect.Person.Update.Response {
...
extension PersonsAPI {
    ...
    public func update(account: String, person: Stripe.Connect.Person.ID, _ request: Stripe.Connect.Person.Update.Request) async throws -> Stripe.Connect.Person.Update.Response {
        try await update(account: account, person: person, request, idempotencyKey: nil)
    }

    public func update(account: String, person: Stripe.Connect.Person.ID, idempotencyKey: String? = nil) async throws -> Stripe.Connect.Person.Update.Response {
