...
public protocol PlansAPI: Sendable {
    ...
    func update(id: Stripe.Billing.Plan.ID, _ request: Stripe.Billing.Plan.Update.Request, idempotencyKey: String?) async throws -> Stripe.Billing.Plan.Update.Response
}
...
public struct PlansClient: PlansAPI {
    ...
    public func retrieve(id: Stripe.Billing.Plan.ID, _ request: Stripe.Billing.Plan.Retrieve.Request) async throws -> Stripe.Billing.Plan.Retrieve.Response {
        try await api.list("v1/plans/\(id)", parameters: request)
    }

    public func update(id: Stripe.Billing.Plan.ID, _ request: Stripe.Billing.Plan.Update.Request, idempotencyKey: String?) async throws -> Stripe.Billing.Plan.Update.Response {
