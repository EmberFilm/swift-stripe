//
//  Generated.ProductsClient.swift
//  Stripe
//
...
public protocol ProductsAPI: Sendable {
    ...
    func retrieve(id: Stripe.Products.Product.ID, _ request: Stripe.Products.Product.Retrieve.Request) async throws -> Stripe.Products.Product.Retrieve.Response
    func search(_ request: Stripe.Products.Product.Search.Request) async throws -> Stripe.Products.Product.Search.Response
    func update(id: Stripe.Products.Product.ID, _ request: Stripe.Products.Product.Update.Request, idempotencyKey: String?) async throws -> Stripe.Products.Product.Update.Response
}
...
public struct ProductsClient: ProductsAPI {
    ...
    public func create(_ request: Stripe.Products.Product.Create.Request, idempotencyKey: String?) async throws -> Stripe.Products.Product.Create.Response {
    ...
    public func retrieve(id: Stripe.Products.Product.ID, _ request: Stripe.Products.Product.Retrieve.Request) async throws -> Stripe.Products.Product.Retrieve.Response {
    ...
    public func update(id: Stripe.Products.Product.ID, _ request: Stripe.Products.Product.Update.Request, idempotencyKey: String?) async throws -> Stripe.Products.Product.Update.Response {
...
extension ProductsAPI {
    ...
    public func update(id: Stripe.Products.Product.ID, _ request: Stripe.Products.Product.Update.Request) async throws -> Stripe.Products.Product.Update.Response {
