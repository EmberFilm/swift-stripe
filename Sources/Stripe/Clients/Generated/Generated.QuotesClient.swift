...
public protocol QuotesAPI: Sendable {
    func accept(id: Stripe.Billing.Quote.ID, _ request: Stripe.Billing.Quote.Accept.Request, idempotencyKey: String?) async throws -> Stripe.Billing.Quote.Accept.Response
    func cancel(id: Stripe.Billing.Quote.ID, _ request: Stripe.Billing.Quote.Cancel.Request, idempotencyKey: String?) async throws -> Stripe.Billing.Quote.Cancel.Response
    ...
    func finalizeQuote(id: Stripe.Billing.Quote.ID, _ request: Stripe.Billing.Quote.FinalizeQuote.Request, idempotencyKey: String?) async throws -> Stripe.Billing.Quote.FinalizeQuote.Response
...
public struct QuotesClient: QuotesAPI {
    ...
    public func accept(id: Stripe.Billing.Quote.ID, _ request: Stripe.Billing.Quote.Accept.Request, idempotencyKey: String?) async throws -> Stripe.Billing.Quote.Accept.Response {
        try await api.send(.POST, "v1/quotes/\(id)/accept", body: request, idempotencyKey: idempotencyKey)
    }

    public func cancel(id: Stripe.Billing.Quote.ID, _ request: Stripe.Billing.Quote.Cancel.Request, idempotencyKey: String?) async throws -> Stripe.Billing.Quote.Cancel.Response {
    ...
    public func finalizeQuote(id: Stripe.Billing.Quote.ID, _ request: Stripe.Billing.Quote.FinalizeQuote.Request, idempotencyKey: String?) async throws -> Stripe.Billing.Quote.FinalizeQuote.Response {
    ...
    public func listComputedUpfrontLineItems(id: Stripe.Billing.Quote.ID, _ request: Stripe.Billing.Quote.ListComputedUpfrontLineItems.Request) async throws -> Stripe.Billing.Quote.ListComputedUpfrontLineItems.Response {
    ...
    public func update(id: Stripe.Billing.Quote.ID, _ request: Stripe.Billing.Quote.Update.Request, idempotencyKey: String?) async throws -> Stripe.Billing.Quote.Update.Response {
...
extension QuotesAPI {
    public func accept(id: Stripe.Billing.Quote.ID, _ request: Stripe.Billing.Quote.Accept.Request) async throws -> Stripe.Billing.Quote.Accept.Response {
    ...
    public func cancel(id: Stripe.Billing.Quote.ID, _ request: Stripe.Billing.Quote.Cancel.Request) async throws -> Stripe.Billing.Quote.Cancel.Response {
    ...
    public func finalizeQuote(id: Stripe.Billing.Quote.ID, _ request: Stripe.Billing.Quote.FinalizeQuote.Request) async throws -> Stripe.Billing.Quote.FinalizeQuote.Response {
    ...
    public func update(id: Stripe.Billing.Quote.ID, _ request: Stripe.Billing.Quote.Update.Request) async throws -> Stripe.Billing.Quote.Update.Response {
