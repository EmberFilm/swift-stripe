//
//  Generated.TaxCalculationsClient.swift
//  Stripe
//
...
public protocol TaxCalculationsAPI: Sendable {
    ...
    func listLineItems(id: Stripe.Tax.Calculation.ID, _ request: Stripe.Tax.Calculation.ListLineItems.Request) async throws -> Stripe.Tax.Calculation.ListLineItems.Response
    func retrieve(id: Stripe.Tax.Calculation.ID, _ request: Stripe.Tax.Calculation.Retrieve.Request) async throws -> Stripe.Tax.Calculation.Retrieve.Response
}
...
public struct TaxCalculationsClient: TaxCalculationsAPI {
    ...
    public func create(_ request: Stripe.Tax.Calculation.Create.Request, idempotencyKey: String?) async throws -> Stripe.Tax.Calculation.Create.Response {
        try await api.send(.POST, "v1/tax/calculations", body: request, idempotencyKey: idempotencyKey)
    }

    public func listLineItems(id: Stripe.Tax.Calculation.ID, _ request: Stripe.Tax.Calculation.ListLineItems.Request) async throws -> Stripe.Tax.Calculation.ListLineItems.Response {
        try await api.list("v1/tax/calculations/\(id)/line_items", parameters: request)
    }

    public func retrieve(id: Stripe.Tax.Calculation.ID, _ request: Stripe.Tax.Calculation.Retrieve.Request) async throws -> Stripe.Tax.Calculation.Retrieve.Response {
