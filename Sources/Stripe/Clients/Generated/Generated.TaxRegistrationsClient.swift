//
//  Generated.TaxRegistrationsClient.swift
//  Stripe
//
...
public protocol TaxRegistrationsAPI: Sendable {
    ...
    func retrieve(id: Stripe.Tax.Registration.ID, _ request: Stripe.Tax.Registration.Retrieve.Request) async throws -> Stripe.Tax.Registration.Retrieve.Response
    func update(id: Stripe.Tax.Registration.ID, _ request: Stripe.Tax.Registration.Update.Request, idempotencyKey: String?) async throws -> Stripe.Tax.Registration.Update.Response
}
...
public struct TaxRegistrationsClient: TaxRegistrationsAPI {
    ...
    public func create(_ request: Stripe.Tax.Registration.Create.Request, idempotencyKey: String?) async throws -> Stripe.Tax.Registration.Create.Response {
    ...
    public func retrieve(id: Stripe.Tax.Registration.ID, _ request: Stripe.Tax.Registration.Retrieve.Request) async throws -> Stripe.Tax.Registration.Retrieve.Response {
        try await api.list("v1/tax/registrations/\(id)", parameters: request)
    }

    public func update(id: Stripe.Tax.Registration.ID, _ request: Stripe.Tax.Registration.Update.Request, idempotencyKey: String?) async throws -> Stripe.Tax.Registration.Update.Response {
...
extension TaxRegistrationsAPI {
    ...
    public func update(id: Stripe.Tax.Registration.ID, _ request: Stripe.Tax.Registration.Update.Request) async throws -> Stripe.Tax.Registration.Update.Response {
