//
//  Generated.TerminalConfigurationsClient.swift
//  Stripe
//
...
public protocol TerminalConfigurationsAPI: Sendable {
    ...
    func retrieve(id: TerminalConfiguration.ID, _ request: TerminalConfiguration.Retrieve.Request) async throws -> TerminalConfiguration.Retrieve.Response
    func update(id: TerminalConfiguration.ID, _ request: TerminalConfiguration.Update.Request, idempotencyKey: String?) async throws -> TerminalConfiguration.Update.Response
}
...
public struct TerminalConfigurationsClient: TerminalConfigurationsAPI {
    ...
    public func retrieve(id: TerminalConfiguration.ID, _ request: TerminalConfiguration.Retrieve.Request) async throws -> TerminalConfiguration.Retrieve.Response {
        try await api.list("v1/terminal/configurations/\(id)", parameters: request)
    }

    public func update(id: TerminalConfiguration.ID, _ request: TerminalConfiguration.Update.Request, idempotencyKey: String?) async throws -> TerminalConfiguration.Update.Response {
...
extension TerminalConfigurationsAPI {
    ...
    public func update(id: TerminalConfiguration.ID, _ request: TerminalConfiguration.Update.Request) async throws -> TerminalConfiguration.Update.Response {
