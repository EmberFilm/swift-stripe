...
public struct TokensClient: TokensAPI {
    ...
    public func retrieve(id: Stripe.Tokens.Token.ID, _ request: Stripe.Tokens.Token.Retrieve.Request) async throws -> Stripe.Tokens.Token.Retrieve.Response {
