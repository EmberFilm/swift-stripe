//
//  Generated.TransfersClient.swift
//  Stripe
//
...
public protocol TransfersAPI: Sendable {
    ...
    func retrieve(id: Stripe.Connect.Transfer.ID, _ request: Stripe.Connect.Transfer.Retrieve.Request) async throws -> Stripe.Connect.Transfer.Retrieve.Response
    func update(id: Stripe.Connect.Transfer.ID, _ request: Stripe.Connect.Transfer.Update.Request, idempotencyKey: String?) async throws -> Stripe.Connect.Transfer.Update.Response
}
...
public struct TransfersClient: TransfersAPI {
    ...
    public func create(_ request: Stripe.Connect.Transfer.Create.Request, idempotencyKey: String?) async throws -> Stripe.Connect.Transfer.Create.Response {
    ...
    public func retrieve(id: Stripe.Connect.Transfer.ID, _ request: Stripe.Connect.Transfer.Retrieve.Request) async throws -> Stripe.Connect.Transfer.Retrieve.Response {
        try await api.list("v1/transfers/\(id)", parameters: request)
    }

    public func update(id: Stripe.Connect.Transfer.ID, _ request: Stripe.Connect.Transfer.Update.Request, idempotencyKey: String?) async throws -> Stripe.Connect.Transfer.Update.Response {
...
extension TransfersAPI {
    ...
    public func update(id: Stripe.Connect.Transfer.ID, _ request: Stripe.Connect.Transfer.Update.Request) async throws -> Stripe.Connect.Transfer.Update.Response {
