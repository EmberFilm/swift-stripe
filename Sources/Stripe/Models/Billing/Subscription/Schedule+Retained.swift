...
extension Stripe.Billing.Subscription.Schedule {
    public struct DefaultSettingsBillingThresholds: Codable, Hashable, Sendable {
        ...
        ///
        /// If true, `billing_cycle_anchor` will be updated to the date/time the threshold was last
        /// reached; otherwise, the value will remain unchanged. This value may not be `true` if the
        /// subscription contains items with plans that have `aggregate_usage=last_ever`.
...
extension Stripe.Billing.Subscription.Schedule {
    public struct TransferData: Codable, Hashable, Sendable {
        ...
        /// to the destination account. By default, the entire amount is transferred to the destination.
...
extension Stripe.Billing.Subscription.Schedule {
    public struct Phase: Codable, Hashable, Sendable {
        ...
        ///
        /// If `phase_start` then billing cycle anchor of the subscription is set to the start of the
        /// phase when entering the phase. If automatic then the billing cycle anchor is automatically
        ...
        ///
        /// When charging automatically, Stripe will attempt to pay the underlying subscription at the
        /// end of each billing cycle using the default source attached to the customer. When sending an
        ...
        ///
        /// It must belong to the customer associated with the subscription schedule. If not set,
        ...
        ///
        /// Metadata on a schedule’s phase will update the underlying subscription’s metadata when the
        /// phase is entered. Updating the underlying subscription’s metadata directly will not affect
        /// the current phase’s metadata.
...
extension Stripe.Billing.Subscription.Schedule {
    public struct PhaseItem: Codable, Hashable, Sendable {
        ...
        ///
        /// Metadata on this item will update the underlying subscription item’s metadata when the phase
        /// is entered.
        public var metadata: [String: String]?
