...
extension Stripe.Checkout {
    /// A Checkout Session represents your customer's session as they pay for one-time purchases or subscriptions through.
    public struct Session: Codable, Hashable, Sendable, Identifiable {
        ...
        public struct AfterExpiration: Codable, Hashable, Sendable {
            ...
            public struct Recovery: Codable, Hashable, Sendable {
                ...
                public var allowPromotionCodes: Bool?
                /// If `true`, a recovery url will be generated to recover this Checkout Session if it expires before a transaction is.
                public var enabled: Bool?
        ...
        public struct Consent: Codable, Hashable, Sendable {
            /// If `opt_in`, the customer consents to receiving promotional communications from the merchant about this Checkout.
        ...
        public struct CustomFields: Codable, Hashable, Sendable {
            ...
            public indirect enum Details: Hashable, Sendable {
                ...
                public var dropdown: Dropdown? {
                    if case .dropdown(let value) = self { return value }
                    return nil
                }
                ...
                fileprivate init(type: String, from container: KeyedDecodingContainer<CodingKeys>) throws {
                    switch type {
                    case "dropdown":
                        if let value = try container.decodeIfPresent(Dropdown.self, forKey: .dropdown) {
                            self = .dropdown(value)
                        } else {
        ...
        public struct CustomerDetails: Codable, Hashable, Sendable {
            ...
            public var businessName: String?
            /// The email associated with the Customer, if one exists, on the Checkout Session after a completed Checkout Session or.
