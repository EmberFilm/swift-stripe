...
extension Stripe.Refunds {
    public struct Refund: Codable, Hashable, Sendable, Identifiable {
        ...
        @ExpandableOf<Stripe.Connect.Transfer.Reversal> public var sourceTransferReversal:
            Stripe.Connect.Transfer.Reversal.ID?
        /// If the accompanying transfer was reversed, the transfer reversal object. Only applicable if the charge was created using the destination parameter.
        @ExpandableOf<Stripe.Connect.Transfer.Reversal> public var transferReversal:
            Stripe.Connect.Transfer.Reversal.ID?
