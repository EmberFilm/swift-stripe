...
extension Stripe.Setup {
    /// A SetupIntent guides you through the process of setting up and saving a customer's payment credentials for future paym…
    public struct Intent: Codable, Hashable, Sendable, Identifiable {
        ...
        /// Status of this SetupIntent, one of `requires_payment_method`, `requires_confirmation`, `requires_action`, `processing`…
        ...
        public struct NextAction: Codable, Hashable, Sendable {
            ...
            /// When confirming a SetupIntent with Stripe.js, Stripe.js depends on the contents of this dictionary to invoke authentic…
            ...
            public init(
                blikAuthorize: Stripe.Shared.BlikAuthorize? = nil,
                cashappHandleRedirectOrDisplayQrCode: Stripe.Shared.CashappHandleRedirectOrDisplayQrCode? = nil,
                pixDisplayQrCode: PixDisplayQrCode? = nil,
                redirectToUrl: RedirectToUrl? = nil,
                `type`: String? = nil,
                upiHandleRedirectOrDisplayQrCode: Stripe.Shared.UpiHandleRedirectOrDisplayQrCode? = nil,
