...
extension Stripe.Payouts {
    /// A `Payout` object is created when you receive funds from Stripe, or when you initiate a payout to either a bank accoun…
    public struct Payout: Codable, Hashable, Sendable, Identifiable {
        ...
        /// If `completed`, you can use the Balance Transactions API to list all balance transactions that are paid out in this pa…
