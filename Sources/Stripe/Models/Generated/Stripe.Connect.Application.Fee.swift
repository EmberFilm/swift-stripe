...
extension Stripe.Connect.Application {
    public struct Fee: Codable, Hashable, Sendable, Identifiable {
        ...
        /// Amount in cents (or local equivalent) refunded (can be less than the amount attribute on the fee if a partial refund w…
        public var amountRefunded: Int?
        /// ID of the Connect application that earned the fee.
        @Expandable<Stripe.Shared.Application, String> public var application: String?
        /// Balance transaction that describes the impact of this collected application fee on your account balance (not including…
