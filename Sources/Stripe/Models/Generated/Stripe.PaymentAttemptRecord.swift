...
extension Stripe {
    ...
    public struct PaymentAttemptRecord: Codable, Hashable, Sendable, Identifiable {
        ...
        public struct PaymentMethodDetails: Codable, Hashable, Sendable {
            ...
            public init(
                achCreditTransfer: Stripe.Shared.AchCreditTransfer? = nil,
                achDebit: Stripe.Shared.AchDebit? = nil,
                ...
                cashapp: Cashapp? = nil,
                crypto: Stripe.Shared.Crypto? = nil,
                custom: Custom? = nil,
                customerBalance: Stripe.Shared.PaymentMethodDetailsCustomerBalance? = nil,
                eps: Eps? = nil,
                fpx: Stripe.Shared.Fpx? = nil,
                giropay: Giropay? = nil,
                grabpay: Stripe.Shared.Grabpay? = nil,
                ideal: Ideal? = nil,
                interacPresent: Stripe.Shared.InteracPresent? = nil,
                kakaoPay: KakaoPay? = nil,
                klarna: Klarna? = nil,
                konbini: Konbini? = nil,
                krCard: Stripe.Shared.KrCard? = nil,
                link: Link? = nil,
                mbWay: MbWay? = nil,
                mobilepay: Mobilepay? = nil,
                multibanco: Multibanco? = nil,
                naverPay: NaverPay? = nil,
                nzBankAccount: Stripe.Shared.NzBankAccount? = nil,
                oxxo: Oxxo? = nil,
                p24: P24? = nil,
                ...
                paynow: Paynow? = nil,
                paypal: Stripe.Shared.Paypal? = nil,
                payto: Payto? = nil,
                pix: Pix? = nil,
                ...
                sepaCreditTransfer: Stripe.Shared.SepaCreditTransfer? = nil,
                sepaDebit: SepaDebit? = nil,
                sofort: Sofort? = nil,
                stripeAccount: Stripe.Shared.StripeAccount? = nil,
                sunbit: Sunbit? = nil,
                swish: Swish? = nil,
                twint: Twint? = nil,
                `type`: String? = nil,
                ...
                wechat: Stripe.Shared.Wechat? = nil,
