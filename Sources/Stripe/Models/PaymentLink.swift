...
extension Stripe {
    ...
    public struct PaymentLink: Codable, Hashable, Sendable, Identifiable {
        ...
        /// This represents the percentage of the subscription invoice total that will be transferred to the application owner's.
        ...
        public struct PaymentIntentData: Codable, Hashable, Sendable {
            ...
            /// For a card payment, information about the charge that appears on the customer's statement when this payment succeeds.
