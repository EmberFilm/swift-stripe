        ...
        public struct DestinationDetails: Codable, Hashable, Sendable {
            ...
            public indirect enum Details: Hashable, Sendable {
                ...
                public var auBankTransfer: AuBankTransfer? {
                    if case .auBankTransfer(let value) = self { return value }
                    return nil
                }
                ...
                public var brBankTransfer: BrBankTransfer? {
                    if case .brBankTransfer(let value) = self { return value }
                    return nil
                }
                ...
                public var customerCashBalance: CustomerCashBalance? {
                    if case .customerCashBalance(let value) = self { return value }
                    return nil
                }
                public var eps: Eps? {
                ...
                public var euBankTransfer: EuBankTransfer? {
                    if case .euBankTransfer(let value) = self { return value }
                    return nil
                }
                public var gbBankTransfer: GbBankTransfer? {
                    if case .gbBankTransfer(let value) = self { return value }
                    return nil
                }
                ...
                public var jpBankTransfer: JpBankTransfer? {
                    if case .jpBankTransfer(let value) = self { return value }
                    return nil
                }
                ...
                public var mxBankTransfer: MxBankTransfer? {
                    if case .mxBankTransfer(let value) = self { return value }
                    return nil
                }
                public var nzBankTransfer: NzBankTransfer? {
                    if case .nzBankTransfer(let value) = self { return value }
                    return nil
                }
                public var p24: P24? {
                ...
                public var revolut: Revolut? {
                    if case .revolut(let value) = self { return value }
                    return nil
                }
                ...
                public var thBankTransfer: ThBankTransfer? {
                    if case .thBankTransfer(let value) = self { return value }
                    return nil
                }
                ...
                public var usBankTransfer: UsBankTransfer? {
                    if case .usBankTransfer(let value) = self { return value }
                    return nil
                }
                ...
                fileprivate init(type: String, from container: KeyedDecodingContainer<CodingKeys>) throws {
                    ...
                    case "au_bank_transfer":
                        if let value = try container.decodeIfPresent(AuBankTransfer.self, forKey: .auBankTransfer) {
                            self = .auBankTransfer(value)
                        } else {
                            self = .unknown(type: type)
                        }
                    case "blik":
                    ...
                    case "br_bank_transfer":
                        if let value = try container.decodeIfPresent(BrBankTransfer.self, forKey: .brBankTransfer) {
                            self = .brBankTransfer(value)
                        } else {
                            self = .unknown(type: type)
                        }
                    case "card":
                    ...
                    case "crypto":
                        if let value = try container.decodeIfPresent(Crypto.self, forKey: .crypto) {
                            self = .crypto(value)
                        } else {
                            self = .unknown(type: type)
                        }
                    case "customer_cash_balance":
                        if let value = try container.decodeIfPresent(CustomerCashBalance.self, forKey: .customerCashBalance) {
                            self = .customerCashBalance(value)
                        } else {
                            self = .unknown(type: type)
                        }
                    case "eps":
                    ...
                    case "eu_bank_transfer":
                        if let value = try container.decodeIfPresent(EuBankTransfer.self, forKey: .euBankTransfer) {
                            self = .euBankTransfer(value)
                        } else {
                            self = .unknown(type: type)
                        }
                    case "gb_bank_transfer":
                        if let value = try container.decodeIfPresent(GbBankTransfer.self, forKey: .gbBankTransfer) {
                            self = .gbBankTransfer(value)
                        } else {
                            self = .unknown(type: type)
                        }
                    case "giropay":
                    ...
                    case "grabpay":
                        if let value = try container.decodeIfPresent(Grabpay.self, forKey: .grabpay) {
                            self = .grabpay(value)
                        } else {
                            self = .unknown(type: type)
                        }
                    case "jp_bank_transfer":
                        if let value = try container.decodeIfPresent(JpBankTransfer.self, forKey: .jpBankTransfer) {
                            self = .jpBankTransfer(value)
                        } else {
                            self = .unknown(type: type)
                        }
                    case "klarna":
                    ...
                    case "mx_bank_transfer":
                        if let value = try container.decodeIfPresent(MxBankTransfer.self, forKey: .mxBankTransfer) {
                            self = .mxBankTransfer(value)
                        } else {
                            self = .unknown(type: type)
                        }
                    case "nz_bank_transfer":
                        if let value = try container.decodeIfPresent(NzBankTransfer.self, forKey: .nzBankTransfer) {
                            self = .nzBankTransfer(value)
                        } else {
                            self = .unknown(type: type)
                        }
                    case "p24":
                    ...
                    case "paypal":
                        if let value = try container.decodeIfPresent(Paypal.self, forKey: .paypal) {
                            self = .paypal(value)
                        } else {
                            self = .unknown(type: type)
                        }
                    ...
                    case "revolut":
                        if let value = try container.decodeIfPresent(Revolut.self, forKey: .revolut) {
                            self = .revolut(value)
                        } else {
                            self = .unknown(type: type)
                        }
                    ...
                    case "th_bank_transfer":
                        if let value = try container.decodeIfPresent(ThBankTransfer.self, forKey: .thBankTransfer) {
                            self = .thBankTransfer(value)
                        } else {
                            self = .unknown(type: type)
                        }
                    case "twint":
                    ...
                    case "us_bank_transfer":
                        if let value = try container.decodeIfPresent(UsBankTransfer.self, forKey: .usBankTransfer) {
                            self = .usBankTransfer(value)
                        } else {
                            self = .unknown(type: type)
                        }
                    case "wechat_pay":
