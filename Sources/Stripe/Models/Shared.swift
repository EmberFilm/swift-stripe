...
extension Stripe.Shared {
    public struct FixedRelease: Codable, Hashable, Sendable {
        ...
        /// The time at which reserved funds are scheduled for release, automatically set to midnight UTC of the day after `releas…
...
extension Stripe.Shared {
    public struct PayerDetails: Codable, Hashable, Sendable {
        /// The payer's address
        public var address: Stripe.Shared.PaymentsPrimitivesPaymentRecordsResourcePaymentMethodKlarnaDetailsResourcePayerDetailsResourcePayerDetailsAddress?
        ...
        public init(
            address: Stripe.Shared.PaymentsPrimitivesPaymentRecordsResourcePaymentMethodKlarnaDetailsResourcePayerDetailsResourcePayerDetailsAddress? = nil
        ) {
            self.address = address
        }
    }
...
extension Stripe.Shared {
    ...
    public struct PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails: Codable, Hashable, Sendable {
        ...
        public indirect enum Details: Hashable, Sendable {
            ...
            public var acssDebit: Stripe.Shared.PaymentMethodDetailsPaymentRecordAcssDebit? { if case .acssDebit(let value) = self { return value }; return nil }
            public var affirm: Stripe.Shared.PaymentMethodDetailsPaymentRecordAffirm? { if case .affirm(let value) = self { return value }; return nil }
            public var afterpayClearpay: Stripe.Shared.PaymentMethodDetailsPaymentRecordAfterpayClearpay? { if case .afterpayClearpay(let value) = self { return value }; return nil }
            public var alipay: Stripe.Shared.PaymentMethodDetailsPaymentRecordAlipay? { if case .alipay(let value) = self { return value }; return nil }
            public var alma: Stripe.Shared.PaymentMethodDetailsPaymentRecordAlma? { if case .alma(let value) = self { return value }; return nil }
            public var amazonPay: Stripe.Shared.PaymentMethodDetailsPaymentRecordAmazonPay? { if case .amazonPay(let value) = self { return value }; return nil }
            public var auBecsDebit: Stripe.Shared.PaymentMethodDetailsPaymentRecordAuBecsDebit? { if case .auBecsDebit(let value) = self { return value }; return nil }
            public var bacsDebit: Stripe.Shared.PaymentMethodDetailsPaymentRecordBacsDebit? { if case .bacsDebit(let value) = self { return value }; return nil }
            public var bancontact: Stripe.Shared.PaymentMethodDetailsPaymentRecordBancontact? { if case .bancontact(let value) = self { return value }; return nil }
            public var billie: Stripe.Shared.PaymentMethodDetailsPaymentRecordBillie? { if case .billie(let value) = self { return value }; return nil }
            public var billingDetails: Stripe.Shared.PaymentsPrimitivesPaymentRecordsResourceBillingDetails? { if case .billingDetails(let value) = self { return value }; return nil }
            public var bizum: Stripe.Shared.PaymentMethodDetailsPaymentRecordBizum? { if case .bizum(let value) = self { return value }; return nil }
            public var blik: Stripe.Shared.PaymentMethodDetailsPaymentRecordBlik? { if case .blik(let value) = self { return value }; return nil }
            public var boleto: Stripe.Shared.PaymentMethodDetailsPaymentRecordBoleto? { if case .boleto(let value) = self { return value }; return nil }
            public var card: Stripe.Shared.PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetails? { if case .card(let value) = self { return value }; return nil }
            public var cardPresent: Stripe.Shared.CardPresent? { if case .cardPresent(let value) = self { return value }; return nil }
            public var cashapp: Stripe.Shared.PaymentMethodDetailsPaymentRecordCashapp? { if case .cashapp(let value) = self { return value }; return nil }
            public var crypto: Stripe.Shared.Crypto? { if case .crypto(let value) = self { return value }; return nil }
            public var custom: Stripe.Shared.Custom? { if case .custom(let value) = self { return value }; return nil }
            ...
            public var eps: Stripe.Shared.PaymentMethodDetailsPaymentRecordEps? { if case .eps(let value) = self { return value }; return nil }
            public var fpx: Stripe.Shared.Fpx? { if case .fpx(let value) = self { return value }; return nil }
            public var giropay: Stripe.Shared.PaymentMethodDetailsPaymentRecordGiropay? { if case .giropay(let value) = self { return value }; return nil }
            public var grabpay: Stripe.Shared.Grabpay? { if case .grabpay(let value) = self { return value }; return nil }
            public var ideal: Stripe.Shared.PaymentMethodDetailsPaymentRecordIdeal? { if case .ideal(let value) = self { return value }; return nil }
            public var interacPresent: Stripe.Shared.InteracPresent? { if case .interacPresent(let value) = self { return value }; return nil }
            public var kakaoPay: Stripe.Shared.PaymentMethodDetailsPaymentRecordKakaoPay? { if case .kakaoPay(let value) = self { return value }; return nil }
            public var klarna: Stripe.Shared.PaymentMethodDetailsPaymentRecordKlarna? { if case .klarna(let value) = self { return value }; return nil }
            public var konbini: Stripe.Shared.PaymentMethodDetailsPaymentRecordKonbini? { if case .konbini(let value) = self { return value }; return nil }
            public var krCard: Stripe.Shared.KrCard? { if case .krCard(let value) = self { return value }; return nil }
            public var link: Stripe.Shared.PaymentMethodDetailsPaymentRecordLink? { if case .link(let value) = self { return value }; return nil }
            public var mbWay: Stripe.Shared.PaymentMethodDetailsPaymentRecordMbWay? { if case .mbWay(let value) = self { return value }; return nil }
            public var mobilepay: Stripe.Shared.PaymentMethodDetailsPaymentRecordMobilepay? { if case .mobilepay(let value) = self { return value }; return nil }
            public var multibanco: Stripe.Shared.PaymentMethodDetailsPaymentRecordMultibanco? { if case .multibanco(let value) = self { return value }; return nil }
            public var naverPay: Stripe.Shared.PaymentMethodDetailsPaymentRecordNaverPay? { if case .naverPay(let value) = self { return value }; return nil }
            public var nzBankAccount: Stripe.Shared.NzBankAccount? { if case .nzBankAccount(let value) = self { return value }; return nil }
            public var oxxo: Stripe.Shared.PaymentMethodDetailsPaymentRecordOxxo? { if case .oxxo(let value) = self { return value }; return nil }
            public var p24: Stripe.Shared.PaymentMethodDetailsPaymentRecordP24? { if case .p24(let value) = self { return value }; return nil }
            public var payByBank: Stripe.Shared.PaymentMethodDetailsPaymentRecordPayByBank? { if case .payByBank(let value) = self { return value }; return nil }
            public var payco: Stripe.Shared.PaymentMethodDetailsPaymentRecordPayco? { if case .payco(let value) = self { return value }; return nil }
            public var paynow: Stripe.Shared.PaymentMethodDetailsPaymentRecordPaynow? { if case .paynow(let value) = self { return value }; return nil }
            public var paypal: Stripe.Shared.Paypal? { if case .paypal(let value) = self { return value }; return nil }
            public var payto: Stripe.Shared.PaymentMethodDetailsPaymentRecordPayto? { if case .payto(let value) = self { return value }; return nil }
            public var pix: Stripe.Shared.PaymentMethodDetailsPaymentRecordPix? { if case .pix(let value) = self { return value }; return nil }
            public var promptpay: Stripe.Shared.PaymentMethodDetailsPaymentRecordPromptpay? { if case .promptpay(let value) = self { return value }; return nil }
            public var revolutPay: Stripe.Shared.PaymentMethodDetailsPaymentRecordRevolutPay? { if case .revolutPay(let value) = self { return value }; return nil }
            public var samsungPay: Stripe.Shared.PaymentMethodDetailsPaymentRecordSamsungPay? { if case .samsungPay(let value) = self { return value }; return nil }
            public var satispay: Stripe.Shared.PaymentMethodDetailsPaymentRecordSatispay? { if case .satispay(let value) = self { return value }; return nil }
            public var scalapay: Stripe.Shared.PaymentMethodDetailsPaymentRecordScalapay? { if case .scalapay(let value) = self { return value }; return nil }
            ...
            public var sepaDebit: Stripe.Shared.PaymentMethodDetailsPaymentRecordSepaDebit? { if case .sepaDebit(let value) = self { return value }; return nil }
            public var sofort: Stripe.Shared.PaymentMethodDetailsPaymentRecordSofort? { if case .sofort(let value) = self { return value }; return nil }
            public var stripeAccount: Stripe.Shared.StripeAccount? { if case .stripeAccount(let value) = self { return value }; return nil }
            public var sunbit: Stripe.Shared.PaymentMethodDetailsPaymentRecordSunbit? { if case .sunbit(let value) = self { return value }; return nil }
            public var swish: Stripe.Shared.PaymentMethodDetailsPaymentRecordSwish? { if case .swish(let value) = self { return value }; return nil }
            public var twint: Stripe.Shared.PaymentMethodDetailsPaymentRecordTwint? { if case .twint(let value) = self { return value }; return nil }
            public var upi: Stripe.Shared.PaymentMethodDetailsPaymentRecordUpi? { if case .upi(let value) = self { return value }; return nil }
            public var usBankAccount: Stripe.Shared.PaymentMethodDetailsPaymentRecordUsBankAccount? { if case .usBankAccount(let value) = self { return value }; return nil }
            public var wechat: Stripe.Shared.Wechat? { if case .wechat(let value) = self { return value }; return nil }
            public var wechatPay: Stripe.Shared.PaymentMethodDetailsPaymentRecordWechatPay? { if case .wechatPay(let value) = self { return value }; return nil }
            public var zip: Stripe.Shared.PaymentMethodDetailsPaymentRecordZip? { if case .zip(let value) = self { return value }; return nil }
            ...
            fileprivate init(type: String, from container: KeyedDecodingContainer<CodingKeys>) throws {
                ...
                case "acss_debit":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordAcssDebit.self, forKey: .acssDebit) { self = .acssDebit(value) } else { self = .unknown(type: type) }
                case "affirm":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordAffirm.self, forKey: .affirm) { self = .affirm(value) } else { self = .unknown(type: type) }
                case "afterpay_clearpay":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordAfterpayClearpay.self, forKey: .afterpayClearpay) { self = .afterpayClearpay(value) } else { self = .unknown(type: type) }
                case "alipay":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordAlipay.self, forKey: .alipay) { self = .alipay(value) } else { self = .unknown(type: type) }
                case "alma":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordAlma.self, forKey: .alma) { self = .alma(value) } else { self = .unknown(type: type) }
                case "amazon_pay":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordAmazonPay.self, forKey: .amazonPay) { self = .amazonPay(value) } else { self = .unknown(type: type) }
                case "au_becs_debit":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordAuBecsDebit.self, forKey: .auBecsDebit) { self = .auBecsDebit(value) } else { self = .unknown(type: type) }
                case "bacs_debit":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordBacsDebit.self, forKey: .bacsDebit) { self = .bacsDebit(value) } else { self = .unknown(type: type) }
                case "bancontact":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordBancontact.self, forKey: .bancontact) { self = .bancontact(value) } else { self = .unknown(type: type) }
                case "billie":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordBillie.self, forKey: .billie) { self = .billie(value) } else { self = .unknown(type: type) }
                case "billing_details":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentsPrimitivesPaymentRecordsResourceBillingDetails.self, forKey: .billingDetails) { self = .billingDetails(value) } else { self = .unknown(type: type) }
                case "bizum":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordBizum.self, forKey: .bizum) { self = .bizum(value) } else { self = .unknown(type: type) }
                case "blik":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordBlik.self, forKey: .blik) { self = .blik(value) } else { self = .unknown(type: type) }
                case "boleto":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordBoleto.self, forKey: .boleto) { self = .boleto(value) } else { self = .unknown(type: type) }
                case "card":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetails.self, forKey: .card) { self = .card(value) } else { self = .unknown(type: type) }
                case "card_present":
                ...
                case "cashapp":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordCashapp.self, forKey: .cashapp) { self = .cashapp(value) } else { self = .unknown(type: type) }
                case "crypto":
                ...
                case "custom":
                    if let value = try container.decodeIfPresent(Stripe.Shared.Custom.self, forKey: .custom) { self = .custom(value) } else { self = .unknown(type: type) }
                ...
                case "eps":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordEps.self, forKey: .eps) { self = .eps(value) } else { self = .unknown(type: type) }
                case "fpx":
                    if let value = try container.decodeIfPresent(Stripe.Shared.Fpx.self, forKey: .fpx) { self = .fpx(value) } else { self = .unknown(type: type) }
                case "giropay":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordGiropay.self, forKey: .giropay) { self = .giropay(value) } else { self = .unknown(type: type) }
                case "grabpay":
                ...
                case "ideal":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordIdeal.self, forKey: .ideal) { self = .ideal(value) } else { self = .unknown(type: type) }
                ...
                case "kakao_pay":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordKakaoPay.self, forKey: .kakaoPay) { self = .kakaoPay(value) } else { self = .unknown(type: type) }
                case "klarna":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordKlarna.self, forKey: .klarna) { self = .klarna(value) } else { self = .unknown(type: type) }
                case "konbini":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordKonbini.self, forKey: .konbini) { self = .konbini(value) } else { self = .unknown(type: type) }
                case "kr_card":
                ...
                case "link":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordLink.self, forKey: .link) { self = .link(value) } else { self = .unknown(type: type) }
                case "mb_way":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordMbWay.self, forKey: .mbWay) { self = .mbWay(value) } else { self = .unknown(type: type) }
                case "mobilepay":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordMobilepay.self, forKey: .mobilepay) { self = .mobilepay(value) } else { self = .unknown(type: type) }
                case "multibanco":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordMultibanco.self, forKey: .multibanco) { self = .multibanco(value) } else { self = .unknown(type: type) }
                case "naver_pay":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordNaverPay.self, forKey: .naverPay) { self = .naverPay(value) } else { self = .unknown(type: type) }
                ...
                case "oxxo":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordOxxo.self, forKey: .oxxo) { self = .oxxo(value) } else { self = .unknown(type: type) }
                case "p24":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordP24.self, forKey: .p24) { self = .p24(value) } else { self = .unknown(type: type) }
                case "pay_by_bank":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordPayByBank.self, forKey: .payByBank) { self = .payByBank(value) } else { self = .unknown(type: type) }
                case "payco":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordPayco.self, forKey: .payco) { self = .payco(value) } else { self = .unknown(type: type) }
                case "paynow":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordPaynow.self, forKey: .paynow) { self = .paynow(value) } else { self = .unknown(type: type) }
                case "paypal":
                ...
                case "payto":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordPayto.self, forKey: .payto) { self = .payto(value) } else { self = .unknown(type: type) }
                case "pix":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordPix.self, forKey: .pix) { self = .pix(value) } else { self = .unknown(type: type) }
                case "promptpay":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordPromptpay.self, forKey: .promptpay) { self = .promptpay(value) } else { self = .unknown(type: type) }
                case "revolut_pay":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordRevolutPay.self, forKey: .revolutPay) { self = .revolutPay(value) } else { self = .unknown(type: type) }
                case "samsung_pay":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordSamsungPay.self, forKey: .samsungPay) { self = .samsungPay(value) } else { self = .unknown(type: type) }
                case "satispay":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordSatispay.self, forKey: .satispay) { self = .satispay(value) } else { self = .unknown(type: type) }
                case "scalapay":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordScalapay.self, forKey: .scalapay) { self = .scalapay(value) } else { self = .unknown(type: type) }
                ...
                case "sepa_debit":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordSepaDebit.self, forKey: .sepaDebit) { self = .sepaDebit(value) } else { self = .unknown(type: type) }
                case "sofort":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordSofort.self, forKey: .sofort) { self = .sofort(value) } else { self = .unknown(type: type) }
                case "stripe_account":
                ...
                case "sunbit":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordSunbit.self, forKey: .sunbit) { self = .sunbit(value) } else { self = .unknown(type: type) }
                case "swish":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordSwish.self, forKey: .swish) { self = .swish(value) } else { self = .unknown(type: type) }
                case "twint":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordTwint.self, forKey: .twint) { self = .twint(value) } else { self = .unknown(type: type) }
                case "upi":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordUpi.self, forKey: .upi) { self = .upi(value) } else { self = .unknown(type: type) }
                case "us_bank_account":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordUsBankAccount.self, forKey: .usBankAccount) { self = .usBankAccount(value) } else { self = .unknown(type: type) }
                case "wechat":
                ...
                case "wechat_pay":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordWechatPay.self, forKey: .wechatPay) { self = .wechatPay(value) } else { self = .unknown(type: type) }
                case "zip":
                    if let value = try container.decodeIfPresent(Stripe.Shared.PaymentMethodDetailsPaymentRecordZip.self, forKey: .zip) { self = .zip(value) } else { self = .unknown(type: type) }
                default: self = .unknown(type: type)
                }
            }
...
extension Stripe.Shared {
    public struct PaymentsPrimitivesPaymentRecordsResourcePaymentMethodKlarnaDetailsResourcePayerDetailsResourcePayerDetailsAddress: Codable, Hashable, Sendable {
...
extension Stripe.Shared {
    public struct PaymentsPrimitivesPaymentRecordsResourcePaymentMethodRevolutPayDetailsResourceFundingResourceFundingCard: Codable, Hashable, Sendable {
        /// Card brand.
        public var brand: String?
        /// Two-letter ISO code representing the country of the card.
        public var country: String?
...
extension Stripe.Shared {
    public struct ReleaseSchedule: Codable, Hashable, Sendable {
        ...
        /// The time at which the ReserveHold is scheduled to be released, automatically set to midnight UTC of the day after `rel…
        public var scheduledRelease: Date?
