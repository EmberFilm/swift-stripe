    ...
    public struct ID: Codable, Hashable, Sendable, Identifiable {
        ...
        public struct Owner: Codable, Hashable, Sendable {
            ...
            public indirect enum Details: Hashable, Sendable {
                ...
                public var account: Expandable<Stripe.Connect.Account, String>? {
                    if case .account(let value) = self { return value }
                    return nil
                }
                public var application: Expandable<Stripe.Shared.Application, String>? {
                    if case .application(let value) = self { return value }
                    return nil
                }
                public var customer: Expandable<Stripe.Customers.Customer, String>? {
                    if case .customer(let value) = self { return value }
                    return nil
                }
