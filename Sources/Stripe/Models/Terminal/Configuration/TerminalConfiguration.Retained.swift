//
//  TerminalConfiguration.Retained.swift
//
//
...
// The TerminalConfiguration struct is generated (Models/Generated). These are the nested types the
// request layer still names under `TerminalConfiguration` that the generator spells differently.
