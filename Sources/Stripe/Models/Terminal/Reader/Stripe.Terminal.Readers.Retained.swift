...
// The Reader struct is generated (Models/Generated). These are the nested types the
// request layer still names under `Stripe.Terminal.Readers.Reader` that the generator spells differently.
