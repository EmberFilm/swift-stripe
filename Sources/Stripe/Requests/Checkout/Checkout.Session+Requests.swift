...
extension Stripe.Checkout.Session.Create {
    public struct Request: Codable, Hashable, Sendable {
        ...
        /// Describes the type of transaction being performed by Checkout in order to customize relevant text on the page, such.
        ...
        public struct AfterExpiration: Codable, Hashable, Sendable {
            ...
            public struct Recovery: Codable, Hashable, Sendable {
                ...
                public var allowPromotionCodes: Bool?
                /// If `true`, a recovery URL will be generated to recover this Checkout Session if it expires before a successful.
                public var enabled: Bool
        ...
        public struct PaymentMethodData: Codable, Hashable, Sendable {
            /// Allow redisplay will be set on the payment method on confirmation and indicates whether this payment method can be.
