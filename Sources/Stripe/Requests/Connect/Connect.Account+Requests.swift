...
extension Stripe.Connect.Account.Create {
    public struct Request: Codable, Hashable, Sendable {
        ...
        public struct Controller: Codable, Hashable, Sendable {
            ...
            /// A hash of configuration for products that have negative balance liability, and whether Stripe or a Connect.
            public var losses: Losses?
            /// A value indicating responsibility for collecting updated information when requirements on the account are due or.
            ...
            public struct StripeDashboard: Codable, Hashable, Sendable {
                /// Whether this account should have access to the full Stripe Dashboard (`full`), to the Express Dashboard (`express`).
                public var `type`: Type?
        ...
        public struct Documents: Codable, Hashable, Sendable {
            ...
            /// One or more documents showing the company's governing document (for example, a memorandum of association.
            public var companyMemorandumOfAssociation: CompanyMemorandumOfAssociation?
            /// One or more documents showing the ministerial decree legalizing the company's establishment.
