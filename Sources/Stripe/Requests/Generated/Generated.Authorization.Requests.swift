//
//  Generated.Authorization.Requests.swift
//  Stripe
//
...
extension Authorization.Approve {
    public struct Request: Codable, Hashable, Sendable {
        /// If the authorization's `pending_request.is_amount_controllable` property is `true`, you may provide this value to cont…
    ...
    public struct Request: Codable, Hashable, Sendable {
        ...
        public struct RiskAssessment: Codable, Hashable, Sendable {
            ...
            public struct CardTestingRisk: Codable, Hashable, Sendable {
                ...
                /// The % of declines due to incorrect verification data (like CVV or expiry) in the past hour, taking place at the same m…
...
extension Authorization.Respond {
    public struct Request: Codable, Hashable, Sendable {
        /// Whether to simulate the user confirming that the transaction was legitimate (true) or telling Stripe that it was fraud…
