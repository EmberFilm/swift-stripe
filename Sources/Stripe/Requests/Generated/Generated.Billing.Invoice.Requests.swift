//
//  Generated.Billing.Invoice.Requests.swift
//  Stripe
//
...
extension Stripe.Billing.Invoice.CreatePreview {
    public struct Request: Codable, Hashable, Sendable {
        ...
        public struct SubscriptionDetails: Codable, Hashable, Sendable {
            ...
            /// For paused subscriptions, setting `subscription_details.resume_at` to `now` will preview the invoice that will be gene…
...
extension Stripe.Billing.Invoice.Pay {
    public struct Request: Codable, Hashable, Sendable {
        /// Specifies which fields in the response should be expanded.
        public var expand: [String]?
        /// In cases where the source used to pay the invoice has insufficient funds, passing `forgive=true` controls whether a ch…
