//
//  Generated.Products.Coupon.Requests.swift
//  Stripe
//
...
extension Stripe.Products.Coupon.Create {
    public struct Request: Codable, Hashable, Sendable {
        ...
        /// Required only if `duration` is `repeating`, in which case it must be a positive integer that specifies the number of m…
