...
extension Stripe.PaymentMethodConfigurations.Configuration.Create {
    public struct Request: Codable, Hashable, Sendable {
        ...
        /// Stripe users can accept Apple Pay in iOS applications in iOS 9 and later, and on the web in Safari starting with iOS.
        ...
        /// Stripe users in the UK can accept Bacs Direct Debit payments from customers with a UK bank account, check this page.
        ...
        /// Billie is a single-use payment method that offers businesses Pay by Invoice where they offer payment terms ranging.
        ...
        /// The Single Euro Payments Area (SEPA) is an initiative of the European Union to simplify payments within and across.
        public var sepaDebit: SepaDebit?
        /// Stripe users in Europe and the United States can use the Payment Intents API—a single integration path for creating.
