...
extension Stripe.Setup.Intent.Confirm {
    public struct Request: Codable, Hashable, Sendable {
        ...
        public struct PaymentMethodOptions: Codable, Hashable, Sendable {
            ...
            public var upi: Upi?
            /// If this is a `us_bank_account` SetupIntent, this sub-hash contains details about the US bank account payment method.
            public var usBankAccount: UsBankAccount?
            ...
            public struct Card: Codable, Hashable, Sendable {
                ...
                public var mandateOptions: MandateOptions?
                /// When specified, this parameter signals that a card has been collected as MOTO (Mail Order Telephone Order) and thus.
