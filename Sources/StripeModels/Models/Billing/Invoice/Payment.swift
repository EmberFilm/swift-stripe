    ...
    public struct Payment: Codable, Hashable, Sendable, Identifiable {
        ...
        public struct Payment: Codable, Hashable, Sendable {
            ...
            public indirect enum Details: Hashable, Sendable {
                ...
                public var charge: Expandable<Stripe.Charges.Charge, String>? {
                    if case .charge(let value) = self { return value }
                    return nil
                }
                public var paymentIntent: Expandable<Stripe.PaymentIntents.PaymentIntent, String>? {
                    if case .paymentIntent(let value) = self { return value }
                    return nil
                }
                public var paymentRecord: Expandable<Stripe.PaymentRecord, String>? {
                    if case .paymentRecord(let value) = self { return value }
                    return nil
                }
                ...
                fileprivate init(type: String, from container: KeyedDecodingContainer<CodingKeys>) throws {
                    ...
                    case "payment_intent":
                        ...
                        if value.wrappedValue != nil || value.projectedValue != nil {
                            self = .paymentIntent(value)
                        } else {
