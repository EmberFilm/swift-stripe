...
extension Stripe.Events.Event {
    ...
    public indirect enum Object: Codable, Hashable, Sendable {
        ...
        public init(from decoder: any Decoder) throws {
            ...
            if let value = try Self.decodeGroup9(object, decoder) {
                self = value
                return
            }
            if let value = try Self.decodeGroup10(object, decoder) {
                self = value
                return
            }
        ...
        private static func decodeGroup0(_ object: String, _ decoder: any Decoder) throws -> Object? {
            ...
            case "billing.credit_balance_transaction":
                return .billingCreditBalanceTransaction(try Stripe.Billing.Credit.Balance.Transaction(from: decoder))
            default: return nil
            }
        }
        ...
        private static func decodeGroup2(_ object: String, _ decoder: any Decoder) throws -> Object? {
            ...
            case "customer_cash_balance_transaction":
                return .customerCashBalanceTransaction(try Stripe.Customers.CashBalanceTransaction(from: decoder))
        ...
        private static func decodeGroup3(_ object: String, _ decoder: any Decoder) throws -> Object? {
            ...
            case "entitlements.active_entitlement_summary":
                return .entitlementsActiveEntitlementSummary(try Stripe.Entitlements.ActiveEntitlementSummary(from: decoder))
            ...
            case "financial_connections.authorization":
                return .financialConnectionsAuthorization(try FinancialConnections.Authorization(from: decoder))
