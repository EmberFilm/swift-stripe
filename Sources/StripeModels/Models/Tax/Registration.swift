            ...
            public struct Us: Codable, Hashable, Sendable {
                ...
                public indirect enum Details: Hashable, Sendable {
                    ...
                    public var localAmusementTax: LocalAmusementTax? {
                        if case .localAmusementTax(let value) = self { return value }
                        return nil
                    }
                    public var localLeaseTax: LocalLeaseTax? {
                        if case .localLeaseTax(let value) = self { return value }
                        return nil
                    }
                    public var massTransitParkingTax: MassTransitParkingTax? {
                        if case .massTransitParkingTax(let value) = self { return value }
                        return nil
                    }
                    public var parkingTax: ParkingTax? {
                        if case .parkingTax(let value) = self { return value }
                        return nil
                    }
                    public var stateSalesTax: StateSalesTax? {
                        if case .stateSalesTax(let value) = self { return value }
                        return nil
                    }
                    ...
                    fileprivate init(type: String, from container: KeyedDecodingContainer<CodingKeys>) throws {
                        ...
                        case "local_amusement_tax":
                            if let value = try container.decodeIfPresent(LocalAmusementTax.self, forKey: .localAmusementTax) {
                                self = .localAmusementTax(value)
                            } else {
                                self = .unknown(type: type)
                            }
                        case "local_lease_tax":
                            if let value = try container.decodeIfPresent(LocalLeaseTax.self, forKey: .localLeaseTax) {
                                self = .localLeaseTax(value)
                            } else {
                                self = .unknown(type: type)
                            }
                        case "mass_transit_parking_tax":
                            if let value = try container.decodeIfPresent(MassTransitParkingTax.self, forKey: .massTransitParkingTax) {
                                self = .massTransitParkingTax(value)
                            } else {
                                self = .unknown(type: type)
                            }
                        case "parking_tax":
                            if let value = try container.decodeIfPresent(ParkingTax.self, forKey: .parkingTax) {
                                self = .parkingTax(value)
                            } else {
                                self = .unknown(type: type)
                            }
                        case "state_sales_tax":
                            if let value = try container.decodeIfPresent(StateSalesTax.self, forKey: .stateSalesTax) {
                                self = .stateSalesTax(value)
                            } else {
                                self = .unknown(type: type)
                            }
