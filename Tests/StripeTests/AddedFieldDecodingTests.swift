...
struct AddedFieldDecodingTests {
    ...
    func subscriptionItem() throws {
        let item = try Self.decode(
            Stripe.Billing.Subscription.Item.self,
            #"""
    ...
    func paymentIntent() throws {
        let intent = try Self.decode(
            Stripe.PaymentIntents.PaymentIntent.self,
            #"""
